...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'eternal-ros-architecture/src/eternal_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'eternal-ros-architecture/install/eternal_description/share/eternal_description/config',
        robot_name
    )
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'eternal_description'
    hmi_package = 'hmi'
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare(hmi_package), 'rviz', rviz_config_filename])
